...
urlpatterns = [
    ...
    path("auth/register", auth.RegisterView.as_view(), name="web_auth_register"),
    path("auth/login", auth.LoginView.as_view(), name="web_auth_login"),
    path(
        "auth/login/google",
    ...
    path("auth/refresh", auth.RefreshTokenView.as_view(), name="web_auth_refresh"),
    path("auth/logout", auth.LogoutView.as_view(), name="web_auth_logout"),
    path(
